...
# Weekly Pulse: committed (Mon) vs actual (Fri) for the current review week.
# Expanded to all 6 KPIs per row. actual_pct = round(actual / committed * 100).
# Status colors via pct_class macro.
WEEKLY_PULSE = {
